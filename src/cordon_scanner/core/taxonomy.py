...
_DOMAIN_BY_PREFIX: tuple[tuple[str, ThreatDomain], ...] = (
    ...
    ("POLICY.CONTAINER.", ThreatDomain.CONTAINER),
    ("SUSPECT.K8S.", ThreatDomain.CONTAINER),
    ("POLICY.K8S.", ThreatDomain.CONTAINER),
    ("SUSPECT.COMPOSE.", ThreatDomain.CONTAINER),
    ("POLICY.COMPOSE.", ThreatDomain.CONTAINER),
    ...
    ("POLICY.RELEASE.", ThreatDomain.PROVENANCE),
...
_CATEGORY_BY_PREFIX: tuple[tuple[str, AttackCategory], ...] = (
    ...
    ("SUSPECT.COMPOSE.", AttackCategory.MISCONFIGURATION),
    ("POLICY.COMPOSE.", AttackCategory.MISCONFIGURATION),
    ("SUSPECT.CFN.", AttackCategory.MISCONFIGURATION),
